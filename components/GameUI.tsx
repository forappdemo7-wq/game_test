...
import { Shield, Zap, Compass, Eye, MessageSquare, AlertTriangle } from 'lucide-react';
    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 font-sans select-none z-10 text-white">
      ...
      <header className="flex justify-between items-start w-full">
        ...
        {mode === GameMode.BATTLE_ROYALE && brZoneRadius < 3000 && (
          <div className="flex items-center space-x-2.5 bg-red-950/80 border border-red-500/40 px-4 py-2.5 rounded-xl shadow-xl w-72 animate-pulse pointer-events-auto">
        ...
        <div className="flex flex-col space-y-2.5 items-end pointer-events-auto">
          <div className="bg-[#111112] border border-white/10 p-4 rounded-none w-60 shadow-xl">
            <h4 className="text-3xs font-black text-[#00f2ff] tracking-[1.5px] uppercase border-b border-white/10 pb-1.5 mb-2 flex justify-between">
              ...
              <span className="text-[#808080] font-mono font-bold uppercase">{mode}</span>
            </h4>
      ...
      <footer className="flex justify-between items-end w-full">
        ...
        <div className="flex space-x-4 bg-[#111112] border border-white/10 p-3 rounded-none pointer-events-auto shadow-2xl">
          ...
          >
            ...
            <span className="text-3xs tracking-widest font-bold font-mono">W-SHIELD</span>
            {cooldowns.shield > 0 && (
              <div
          ...
          >
            ...
            <span className="text-3xs tracking-widest font-bold font-mono">E-VACUUM</span>
            {cooldowns.magnet > 0 && (
              <div
                className="absolute inset-0 bg-[#050505]/95 rounded-none border border-red-500/25 flex items-center justify-center font-mono text-3xs font-black text-red-400"
              >
          ...
          >
            ...
            <span className="text-3xs tracking-widest font-bold font-mono">R-PHASE</span>
            {cooldowns.ghost > 0 && (
              <div
                className="absolute inset-0 bg-[#050505]/95 rounded-none border border-red-500/25 flex items-center justify-center font-mono text-3xs font-black text-red-400"
              >
      ...
      {localPlayer && localPlayer.isDead && (
        <div className="absolute inset-0 bg-[#050505]/95 backdrop-blur-md pointer-events-auto flex items-center justify-center z-50">
          <div className="bg-[#111112] border border-white/10 p-8 rounded-none w-full max-w-md text-center shadow-2xl border-t-2 border-t-[#00f2ff]">
